...
commandexe       = hmmer_base.amd64-m64-gcc43-nn
...
log_line_width   = 0
log_timestamp    = 0
logname          = /home/yunqi/SPEC2006/result/CPU2006.013.log
lognum           = 013
mach             = default
mail_reports     = all
mailcompress     = 0
...
path             = /home/yunqi/SPEC2006/benchspec/CPU2006/456.hmmer
plain_train      = 1
preenv           = 1
prefix           = 
prepared_by      = 
...
run              = all
rundir           = run
runspec          = /home/yunqi/SPEC2006/bin/runspec -c profile -o text --noreportable --action build -size=train hmmer
safe_eval        = 1
