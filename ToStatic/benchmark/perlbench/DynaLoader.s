...
# -D PERL_CORE -D SPEC_CPU_LP64 -D SPEC_CPU_LINUX_X64 DynaLoader.c
...
.Ltext0:
	.section	.rodata
.LC0:
	.string	"Usage: DynaLoader::dl_error()"
.LC1:
...
.LFB2:
	...
	movl	(%rax), %eax	# *PL_markstack_ptr.2_5, D.10397
	cltq
	salq	$3, %rax	#, D.10398
	leaq	(%rcx,%rax), %r12	#, mark
	movq	%r12, %rdx	# mark, mark.4
	movq	PL_stack_base(%rip), %rax	# PL_stack_base, PL_stack_base.5
	subq	%rax, %rdx	# PL_stack_base.6, D.10399
	movq	%rdx, %rax	# D.10399, D.10399
	sarq	$3, %rax	#, tmp103
	addl	$1, %eax	#, D.10400
	movl	%eax, -48(%rbp)	# D.10400, ax
	movq	%rbx, %rdx	# sp, sp.7
	movq	%r12, %rax	# mark, mark.8
	subq	%rax, %rdx	# mark.8, D.10399
	movq	%rdx, %rax	# D.10399, D.10399
	sarq	$3, %rax	#, tmp104
	movl	%eax, -44(%rbp)	# D.10399, items
	.loc 1 24 0
	cmpl	$0, -44(%rbp)	#, items
	je	.L2	#,
	.loc 1 25 0
...
.LBB2:
	...
	movzbl	37(%rax), %eax	# PL_op.10_24->op_private, D.10401
	movzbl	%al, %eax	# D.10401, D.10397
	andl	$32, %eax	#, D.10397
	testl	%eax, %eax	# D.10397
	je	.L3	#,
	.loc 1 28 0 is_stmt 0 discriminator 1
	movq	PL_curpad(%rip), %rdx	# PL_curpad, PL_curpad.11
	movq	PL_op(%rip), %rax	# PL_op, PL_op.12
	movq	24(%rax), %rax	# PL_op.12_29->op_targ, D.10398
	salq	$3, %rax	#, D.10398
	addq	%rdx, %rax	# PL_curpad.11, D.10402
	movq	(%rax), %rax	# *_32, iftmp.9
	jmp	.L4	#
.L3:
...
.L4:
	...
	movq	%rax, -40(%rbp)	# iftmp.9, targ
	.loc 1 30 0 is_stmt 1 discriminator 3
	movq	$.LC1, -32(%rbp)	#, RETVAL
	.loc 1 32 0 discriminator 3
	movq	-32(%rbp), %rdx	# RETVAL, tmp105
	movq	-40(%rbp), %rax	# targ, tmp106
	movq	%rdx, %rsi	# tmp105,
	movq	%rax, %rdi	# tmp106,
	call	Perl_sv_setpv	#
	movq	PL_stack_base(%rip), %rax	# PL_stack_base, PL_stack_base.13
	movl	-48(%rbp), %edx	# ax, tmp107
	movslq	%edx, %rdx	# tmp107, D.10398
	salq	$3, %rdx	#, D.10398
	subq	$8, %rdx	#, D.10403
	leaq	(%rax,%rdx), %rbx	#, sp
.LBB3:
	movq	-40(%rbp), %rax	# targ, tmp108
	movl	12(%rax), %eax	# targ_35->sv_flags, D.10404
	andl	$16384, %eax	#, D.10404
	testl	%eax, %eax	# D.10404
	je	.L5	#,
	.loc 1 32 0 is_stmt 0 discriminator 1
	movq	-40(%rbp), %rax	# targ, tmp109
	movq	%rax, %rdi	# tmp109,
	call	Perl_mg_set	#
.L5:
	.loc 1 32 0 discriminator 2
	addq	$8, %rbx	#, sp
	movq	-40(%rbp), %rax	# targ, tmp110
	movq	%rax, (%rbx)	# tmp110, *sp_44
.LBE3:
.LBE2:
.LBB4:
	...
	movslq	%edx, %rcx	# tmp111, D.10403
	movq	-24(%rbp), %rdx	# tmpXSoff, tmpXSoff.15
	addq	%rcx, %rdx	# D.10403, D.10403
	salq	$3, %rdx	#, D.10403
	subq	$8, %rdx	#, D.10403
	addq	%rdx, %rax	# D.10403, PL_stack_sp.16
...
.LBE4:
	...
	.cfi_endproc
.LFE2:
	.size	XS_DynaLoader_dl_error, .-XS_DynaLoader_dl_error
	.section	.rodata
.LC2:
	.string	"DynaLoader.c"
.LC3:
	.string	"DynaLoader::dl_error"
	.text
...
.LFB3:
	...
	movl	(%rax), %eax	# *PL_markstack_ptr.19_4, D.10408
	cltq
	salq	$3, %rax	#, D.10409
	leaq	(%rcx,%rax), %rbx	#, mark
	movq	%rbx, %rdx	# mark, mark.21
	movq	PL_stack_base(%rip), %rax	# PL_stack_base, PL_stack_base.22
	subq	%rax, %rdx	# PL_stack_base.23, D.10410
	movq	%rdx, %rax	# D.10410, D.10410
	sarq	$3, %rax	#, tmp90
	addl	$1, %eax	#, D.10411
	movl	%eax, -40(%rbp)	# D.10411, ax
	movq	%r12, %rdx	# sp, sp.24
	movq	%rbx, %rax	# mark, mark.25
	subq	%rax, %rdx	# mark.25, D.10410
	movq	%rdx, %rax	# D.10410, D.10410
	sarq	$3, %rax	#, tmp91
	movl	%eax, -36(%rbp)	# D.10410, items
	.loc 1 44 0
	movq	$.LC2, -32(%rbp)	#, file
	.loc 1 48 0
	movq	-32(%rbp), %rax	# file, tmp92
	movq	%rax, %rdx	# tmp92,
	movl	$XS_DynaLoader_dl_error, %esi	#,
	movl	$.LC3, %edi	#,
	call	Perl_newXS	#
.LBB5:
	.loc 1 49 0
	...
	movslq	%edx, %rdx	# tmp93, D.10409
	salq	$3, %rdx	#, D.10409
	addq	%rdx, %rax	# D.10409, D.10412
	movq	$PL_sv_yes, (%rax)	#, *_27
.LBB6:
	movq	$1, -24(%rbp)	#, tmpXSoff
	movq	PL_stack_base(%rip), %rax	# PL_stack_base, PL_stack_base.27
	movl	-40(%rbp), %edx	# ax, tmp94
	movslq	%edx, %rcx	# tmp94, D.10413
	movq	-24(%rbp), %rdx	# tmpXSoff, tmpXSoff.28
	addq	%rcx, %rdx	# D.10413, D.10413
	salq	$3, %rdx	#, D.10413
	subq	$8, %rdx	#, D.10413
	addq	%rdx, %rax	# D.10413, PL_stack_sp.29
	movq	%rax, PL_stack_sp(%rip)	# PL_stack_sp.29, PL_stack_sp
	nop
.LBE6:
.LBE5:
	.loc 1 50 0
	...
	.cfi_endproc
.LFE3:
	.size	boot_DynaLoader, .-boot_DynaLoader
.Letext0:
