...
# subvec.c -mtune=generic -march=x86-64 -g -fverbose-asm
...
# -msse2 -mtls-direct-seg-refs
	...
	.text
.Ltext0:
	.globl	sub_su3_vector
	.type	sub_su3_vector, @function
sub_su3_vector:
.LFB0:
	.file 1 "subvec.c"
	.loc 1 11 0
...
.L3:
	...
	movsd	(%rax), %xmm0	# a_3(D)->c[i_1].real, D.2178
	movq	-24(%rbp), %rax	# b, tmp70
	movslq	%ebx, %rdx	# i, tmp71
	salq	$4, %rdx	#, tmp72
	addq	%rdx, %rax	# tmp72, tmp73
	movsd	(%rax), %xmm1	# b_5(D)->c[i_1].real, D.2178
	subsd	%xmm1, %xmm0	# D.2178, D.2178
	...
	addq	$8, %rax	#, tmp82
	movsd	(%rax), %xmm0	# a_3(D)->c[i_1].imag, D.2178
	movq	-24(%rbp), %rax	# b, tmp83
	movslq	%ebx, %rdx	# i, tmp84
	salq	$4, %rdx	#, tmp85
	addq	%rdx, %rax	# tmp85, tmp86
	addq	$8, %rax	#, tmp87
	movsd	(%rax), %xmm1	# b_5(D)->c[i_1].imag, D.2178
	subsd	%xmm1, %xmm0	# D.2178, D.2178
...
.L2:
	...
	.cfi_endproc
.LFE0:
	.size	sub_su3_vector, .-sub_su3_vector
.Letext0:
	.file 2 "complex.h"
	.file 3 "su3.h"
