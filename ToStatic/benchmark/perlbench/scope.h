...
struct jmpenv {
#if defined(SPEC_CPU)
#if defined(SPEC_CPU_IA64_GCC_ALIGNMENT)
    /* The ABI says the __jmp_buf element type should be __float80,
     * but the header defines it as a long with aligned(16), and 
     * gcc doesn't understand this.  Put a __float80 here to force
     ...
     */
#endif /* !SPEC_CPU_IA64_GCC_ALIGNMENT */
