...
# s_m_vec.c -mtune=generic -march=x86-64 -g -fverbose-asm
...
# -msse2 -mtls-direct-seg-refs
	...
	.text
.Ltext0:
	.globl	scalar_mult_su3_vector
	.type	scalar_mult_su3_vector, @function
...
.L3:
	...
	salq	$4, %rdx	#, tmp66
	addq	%rdx, %rax	# tmp66, tmp67
	movsd	(%rax), %xmm0	# a_3(D)->c[i_1].real, D.2176
	mulsd	-24(%rbp), %xmm0	# s, D.2176
	movq	-32(%rbp), %rax	# c, tmp68
	movslq	%ebx, %rdx	# i, tmp69
	salq	$4, %rdx	#, tmp70
	addq	%rdx, %rax	# tmp70, tmp71
	movsd	%xmm0, (%rax)	# D.2176, c_7(D)->c[i_1].real
	...
	addq	$8, %rax	#, tmp76
	movsd	(%rax), %xmm0	# a_3(D)->c[i_1].imag, D.2176
	mulsd	-24(%rbp), %xmm0	# s, D.2176
	movq	-32(%rbp), %rax	# c, tmp77
	movslq	%ebx, %rdx	# i, tmp78
	salq	$4, %rdx	#, tmp79
	addq	%rdx, %rax	# tmp79, tmp80
	addq	$8, %rax	#, tmp81
	movsd	%xmm0, (%rax)	# D.2176, c_7(D)->c[i_1].imag
...
.L2:
	...
	.cfi_endproc
.LFE0:
	.size	scalar_mult_su3_vector, .-scalar_mult_su3_vector
.Letext0:
	.file 2 "complex.h"
	.file 3 "su3.h"
