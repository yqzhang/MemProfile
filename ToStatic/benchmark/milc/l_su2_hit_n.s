...
# l_su2_hit_n.c -mtune=generic -march=x86-64 -g -fverbose-asm
...
# -msse2 -mtls-direct-seg-refs
	...
	.text
.Ltext0:
	.globl	left_su2_hit_n
	.type	left_su2_hit_n, @function
left_su2_hit_n:
.LFB0:
	.file 1 "l_su2_hit_n.c"
	.loc 1 11 0
	.cfi_startproc
	pushq	%rbp	#
...
.L3:
	...
	movslq	%ebx, %rcx	# m, tmp62
	movl	-32(%rbp), %eax	# q, tmp64
	...
	movslq	%ebx, %rcx	# m, tmp69
	movl	-28(%rbp), %eax	# p, tmp71
...
.L2:
	...
	.cfi_endproc
.LFE0:
	.size	left_su2_hit_n, .-left_su2_hit_n
.Letext0:
	.file 2 "complex.h"
	.file 3 "su3.h"
