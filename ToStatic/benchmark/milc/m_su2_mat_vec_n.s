...
# m_su2_mat_vec_n.c -mtune=generic -march=x86-64 -g -fverbose-asm
...
# -msse2 -mtls-direct-seg-refs
	...
	.text
.Ltext0:
	.globl	mult_su2_mat_vec_elem_n
	.type	mult_su2_mat_vec_elem_n, @function
mult_su2_mat_vec_elem_n:
.LFB0:
	.file 1 "m_su2_mat_vec_n.c"
	.loc 1 11 0
	.cfi_startproc
	pushq	%rbp	#
	...
	movsd	(%rax), %xmm1	# u_3(D)->e[0][0].real, D.2240
	movsd	-32(%rbp), %xmm0	# t0.real, D.2240
	mulsd	%xmm1, %xmm0	# D.2240, D.2240
	movq	-72(%rbp), %rax	# u, tmp132
	movsd	8(%rax), %xmm2	# u_3(D)->e[0][0].imag, D.2240
	...
	movsd	(%rax), %xmm1	# u_3(D)->e[0][0].real, D.2240
	movsd	-24(%rbp), %xmm0	# t0.imag, D.2240
	...
	movsd	16(%rax), %xmm1	# u_3(D)->e[0][1].real, D.2240
	movsd	-16(%rbp), %xmm0	# t1.real, D.2240
	mulsd	%xmm1, %xmm0	# D.2240, D.2240
	movq	-72(%rbp), %rax	# u, tmp136
	movsd	24(%rax), %xmm2	# u_3(D)->e[0][1].imag, D.2240
	...
	movsd	16(%rax), %xmm1	# u_3(D)->e[0][1].real, D.2240
	movsd	-8(%rbp), %xmm0	# t1.imag, D.2240
	mulsd	%xmm0, %xmm1	# D.2240, D.2240
	...
	movsd	32(%rax), %xmm1	# u_3(D)->e[1][0].real, D.2240
	movsd	-32(%rbp), %xmm0	# t0.real, D.2240
	mulsd	%xmm1, %xmm0	# D.2240, D.2240
	movq	-72(%rbp), %rax	# u, tmp142
	movsd	40(%rax), %xmm2	# u_3(D)->e[1][0].imag, D.2240
	movsd	-24(%rbp), %xmm1	# t0.imag, D.2240
	mulsd	%xmm2, %xmm1	# D.2240, D.2240
	subsd	%xmm1, %xmm0	# D.2240, D.2240
	movsd	%xmm0, -64(%rbp)	# D.2240, z0.real
	...
	movsd	48(%rax), %xmm1	# u_3(D)->e[1][1].real, D.2240
	movsd	-16(%rbp), %xmm0	# t1.real, D.2240
	mulsd	%xmm1, %xmm0	# D.2240, D.2240
	movq	-72(%rbp), %rax	# u, tmp146
	movsd	56(%rax), %xmm2	# u_3(D)->e[1][1].imag, D.2240
	movsd	-8(%rbp), %xmm1	# t1.imag, D.2240
	mulsd	%xmm2, %xmm1	# D.2240, D.2240
	subsd	%xmm1, %xmm0	# D.2240, D.2240
	movsd	%xmm0, -48(%rbp)	# D.2240, z1.real
	...
	.cfi_endproc
.LFE0:
	.size	mult_su2_mat_vec_elem_n, .-mult_su2_mat_vec_elem_n
.Letext0:
	.file 2 "complex.h"
	.file 3 "su3.h"
...
.LASF11:
	.string	"mult_su2_mat_vec_elem_n"
