...
# m_matvec.c -mtune=generic -march=x86-64 -g -fverbose-asm
...
.L3:
	...
	movsd	(%rax), %xmm0	# a_3(D)->e[i_1][0].real, ar
	...
	addq	$8, %rax	#, tmp78
	movsd	(%rax), %xmm5	# a_3(D)->e[i_1][0].imag, ai
	...
	salq	$4, %rax	#, tmp85
	addq	%rcx, %rax	# tmp81, tmp86
	addq	$16, %rax	#, tmp87
	movsd	(%rax), %xmm5	# a_3(D)->e[i_1][1].real, ar
	...
	addq	$24, %rax	#, tmp94
	movsd	(%rax), %xmm7	# a_3(D)->e[i_1][1].imag, ai
	...
	addq	$32, %rax	#, tmp103
	movsd	(%rax), %xmm0	# a_3(D)->e[i_1][2].real, ar
	movq	-24(%rbp), %rcx	# a, tmp104
	...
	salq	$4, %rax	#, tmp108
	addq	%rcx, %rax	# tmp104, tmp109
	addq	$40, %rax	#, tmp110
	movsd	(%rax), %xmm7	# a_3(D)->e[i_1][2].imag, ai
...
.L2:
	...
	.cfi_endproc
.LFE0:
	.size	mult_su3_mat_vec, .-mult_su3_mat_vec
.Letext0:
	.file 2 "complex.h"
	.file 3 "su3.h"
