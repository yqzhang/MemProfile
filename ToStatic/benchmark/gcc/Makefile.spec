...
BENCH_FLAGS      = -I.
CC               = /usr/bin/gcc
COPTIMIZE        = -g -fno-strict-aliasing
CXX              = /usr/bin/g++
CXXOPTIMIZE      = -g -fno-strict-aliasing
FC               = /usr/bin/gfortran
FOPTIMIZE        = -g -fno-strict-aliasing
FPBASE           = yes
OS               = unix
...
commandexe       = gcc_base.amd64-m64-gcc43-nn
...
compwhite        = 
configdir        = config
configpath       = /home/yunqi/SPEC2006/config/profile.cfg
copies           = 1
datadir          = data
delay            = 0
deletebinaries   = 0
...
log_line_width   = 0
log_timestamp    = 0
logname          = /home/yunqi/SPEC2006/result/CPU2006.010.log
lognum           = 010
mach             = default
mail_reports     = all
mailcompress     = 0
...
path             = /home/yunqi/SPEC2006/benchspec/CPU2006/403.gcc
plain_train      = 1
preenv           = 1
prefix           = 
prepared_by      = 
...
run              = all
rundir           = run
runspec          = /home/yunqi/SPEC2006/bin/runspec -c profile -o text --noreportable --action build -size=train gcc
safe_eval        = 1
