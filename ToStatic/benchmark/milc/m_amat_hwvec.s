...
# m_amat_hwvec.c -mtune=generic -march=x86-64 -g -fverbose-asm
...
# -msse2 -mtls-direct-seg-refs
	...
	.text
.Ltext0:
	.globl	mult_adj_su3_mat_hwvec
	.type	mult_adj_su3_mat_hwvec, @function
mult_adj_su3_mat_hwvec:
.LFB0:
	.file 1 "m_amat_hwvec.c"
	.loc 1 22 0
	.cfi_startproc
	pushq	%rbp	#
	...
	movsd	48(%rax), %xmm4	# mat_1(D)->e[1][0].real, a1r
	movq	-8(%rbp), %rax	# mat, tmp208
	movsd	56(%rax), %xmm5	# mat_1(D)->e[1][0].imag, a1i
	.loc 1 37 0
	...
	movsd	96(%rax), %xmm6	# mat_1(D)->e[2][0].real, a2r
	movq	-8(%rbp), %rax	# mat, tmp212
	movsd	104(%rax), %xmm7	# mat_1(D)->e[2][0].imag, a2i
	.loc 1 39 0
	...
	movsd	112(%rax), %xmm5	# mat_1(D)->e[2][1].real, a2r
	movq	-8(%rbp), %rax	# mat, tmp226
	movsd	120(%rax), %xmm7	# mat_1(D)->e[2][1].imag, a2i
	.loc 1 49 0
	...
	.loc 1 51 0
	movapd	%xmm4, %xmm1	# a0r, D.2312
	mulsd	%xmm14, %xmm1	# b0r, D.2312
	movapd	%xmm6, %xmm0	# a0i, D.2312
	mulsd	%xmm15, %xmm0	# b0i, D.2312
	addsd	%xmm0, %xmm1	# D.2312, D.2312
	movapd	%xmm2, %xmm0	# a1r, D.2312
	mulsd	%xmm8, %xmm0	# b1r, D.2312
	addsd	%xmm0, %xmm1	# D.2312, D.2312
	movapd	%xmm3, %xmm0	# a1i, D.2312
	...
	movsd	32(%rax), %xmm2	# mat_1(D)->e[0][2].real, a0r
	movq	-8(%rbp), %rax	# mat, tmp232
	movsd	40(%rax), %xmm4	# mat_1(D)->e[0][2].imag, a0i
	.loc 1 55 0
	...
	movsd	80(%rax), %xmm5	# mat_1(D)->e[1][2].real, a1r
	movq	-8(%rbp), %rax	# mat, tmp236
	movsd	88(%rax), %xmm6	# mat_1(D)->e[1][2].imag, a1i
	.loc 1 57 0
	...
	.loc 1 61 0
	movapd	%xmm2, %xmm1	# a0r, D.2312
	mulsd	%xmm12, %xmm1	# b0r, D.2312
	movapd	%xmm4, %xmm0	# a0i, D.2312
	mulsd	%xmm13, %xmm0	# b0i, D.2312
	addsd	%xmm0, %xmm1	# D.2312, D.2312
	movapd	%xmm5, %xmm0	# a1r, D.2312
	mulsd	%xmm14, %xmm0	# b1r, D.2312
	addsd	%xmm0, %xmm1	# D.2312, D.2312
	movapd	%xmm6, %xmm0	# a1i, D.2312
	...
	movsd	48(%rax), %xmm3	# mat_1(D)->e[1][0].real, a1r
	movq	-8(%rbp), %rax	# mat, tmp250
	movsd	56(%rax), %xmm4	# mat_1(D)->e[1][0].imag, a1i
	.loc 1 70 0
	...
	.loc 1 74 0
	movapd	%xmm5, %xmm1	# a0r, D.2312
	mulsd	%xmm10, %xmm1	# b0r, D.2312
	movapd	%xmm2, %xmm0	# a0i, D.2312
	mulsd	%xmm11, %xmm0	# b0i, D.2312
	addsd	%xmm0, %xmm1	# D.2312, D.2312
	movapd	%xmm3, %xmm0	# a1r, D.2312
	mulsd	%xmm12, %xmm0	# b1r, D.2312
	addsd	%xmm0, %xmm1	# D.2312, D.2312
	movapd	%xmm4, %xmm0	# a1i, D.2312
	...
	movsd	16(%rax), %xmm3	# mat_1(D)->e[0][1].real, a0r
	movq	-8(%rbp), %rax	# mat, tmp260
	movsd	24(%rax), %xmm5	# mat_1(D)->e[0][1].imag, a0i
	.loc 1 78 0
	...
	movsd	112(%rax), %xmm4	# mat_1(D)->e[2][1].real, a2r
	...
	movapd	%xmm1, %xmm13	# b2i, b2i
	.loc 1 84 0
	movapd	%xmm3, %xmm1	# a0r, D.2312
	mulsd	%xmm8, %xmm1	# b0r, D.2312
	movapd	%xmm5, %xmm0	# a0i, D.2312
	mulsd	%xmm9, %xmm0	# b0i, D.2312
	addsd	%xmm0, %xmm1	# D.2312, D.2312
	movapd	%xmm6, %xmm0	# a1r, D.2312
	mulsd	%xmm10, %xmm0	# b1r, D.2312
	addsd	%xmm0, %xmm1	# D.2312, D.2312
	movapd	%xmm2, %xmm0	# a1i, D.2312
	mulsd	%xmm11, %xmm0	# b1i, D.2312
	addsd	%xmm0, %xmm1	# D.2312, D.2312
	...
	movsd	32(%rax), %xmm6	# mat_1(D)->e[0][2].real, a0r
	movq	-8(%rbp), %rax	# mat, tmp274
	movsd	40(%rax), %xmm3	# mat_1(D)->e[0][2].imag, a0i
	.loc 1 88 0
	...
	movsd	80(%rax), %xmm4	# mat_1(D)->e[1][2].real, a1r
	movq	-8(%rbp), %rax	# mat, tmp278
	movsd	88(%rax), %xmm5	# mat_1(D)->e[1][2].imag, a1i
	.loc 1 90 0
	...
	.cfi_endproc
.LFE0:
	.size	mult_adj_su3_mat_hwvec, .-mult_adj_su3_mat_hwvec
.Letext0:
	.file 2 "complex.h"
	.file 3 "su3.h"
