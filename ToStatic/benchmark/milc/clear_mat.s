...
# clear_mat.c -mtune=generic -march=x86-64 -g -fverbose-asm
...
.L4:
	...
	movq	-24(%rbp), %rcx	# dest, tmp62
	movslq	%r12d, %rsi	# j, tmp63
	movslq	%ebx, %rdx	# i, tmp64
	movq	%rdx, %rax	# tmp64, tmp65
	addq	%rax, %rax	# tmp65
	addq	%rdx, %rax	# tmp64, tmp65
	addq	%rsi, %rax	# tmp63, tmp66
	salq	$4, %rax	#, tmp67
	addq	%rcx, %rax	# tmp62, tmp68
	leaq	8(%rax), %rdx	#, tmp69
	movl	$0, %eax	#, tmp70
	movq	%rax, (%rdx)	# tmp70, dest_5(D)->e[i_1][j_2].imag
	movq	-24(%rbp), %rcx	# dest, tmp71
	...
	addq	$8, %rax	#, tmp78
	movq	(%rax), %rdx	# dest_5(D)->e[i_1][j_2].imag, D.2175
	movq	-24(%rbp), %rsi	# dest, tmp79
	movslq	%r12d, %rdi	# j, tmp80
	movslq	%ebx, %rcx	# i, tmp81
	movq	%rcx, %rax	# tmp81, tmp82
	addq	%rax, %rax	# tmp82
	addq	%rcx, %rax	# tmp81, tmp82
	addq	%rdi, %rax	# tmp80, tmp83
	salq	$4, %rax	#, tmp84
	addq	%rsi, %rax	# tmp79, tmp85
	movq	%rdx, (%rax)	# D.2175, dest_5(D)->e[i_1][j_2].real
...
.L2:
	...
	.cfi_endproc
.LFE0:
	.size	clear_su3mat, .-clear_su3mat
.Letext0:
	.file 2 "complex.h"
	.file 3 "su3.h"
