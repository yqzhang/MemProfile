...
# addmat.c -mtune=generic -march=x86-64 -g -fverbose-asm
...
.L4:
	...
	movsd	(%rax), %xmm1	# a_5(D)->e[i_1][j_2].real, D.2182
	...
	movsd	(%rax), %xmm0	# b_7(D)->e[i_1][j_2].real, D.2182
	addsd	%xmm1, %xmm0	# D.2182, D.2182
	...
	addq	$8, %rax	#, tmp95
	movsd	(%rax), %xmm1	# a_5(D)->e[i_1][j_2].imag, D.2182
	...
	addq	$8, %rax	#, tmp103
	movsd	(%rax), %xmm0	# b_7(D)->e[i_1][j_2].imag, D.2182
	addsd	%xmm1, %xmm0	# D.2182, D.2182
...
.L2:
	...
	.cfi_endproc
.LFE0:
	.size	add_su3_matrix, .-add_su3_matrix
.Letext0:
	.file 2 "complex.h"
	.file 3 "su3.h"
